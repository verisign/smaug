 ...
 * Portions created by Patrick Brunschwig <patrick@smaug.net>
...
const SMG_SMGMSGCOMPFIELDS_CONTRACTID =
    "@mozdev.org/smaug/composefields;1";
const SMG_SMGMSGCOMPFIELDS_CID =
    Components.ID("{847b3a30-7ab1-11d4-8f02-006008948af5}");

function SmgMsgCompFields()
{
}

SmgMsgCompFields.prototype = {

  classDescription: "Smaug Msg Compose Fields",
  classID:  SMG_SMGMSGCOMPFIELDS_CID,
  contractID: SMG_SMGMSGCOMPFIELDS_CONTRACTID,
  QueryInterface: XPCOMUtils.generateQI([
    Ci.nsISmgMsgCompFields,
    Ci.nsSmgMsgCompFields,
...
var NSGetFactory = XPCOMUtils.generateNSGetFactory([SmgMsgCompFields]);
